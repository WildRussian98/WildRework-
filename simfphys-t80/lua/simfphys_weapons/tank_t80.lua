...
function simfphys.weapon:Initialize( vehicle )
	...
	vehicle:SetNWString( "WeaponMode", "125-MM 2А46М-1: 3БМ46 (ОБПС)" )	
	vehicle:SetNWBool( "SpecialCam_Loader", true )
	vehicle:SetNWBool( "SpecialCam_Loader2", true )
	...
	simfphys.RegisterCamera( vehicle:GetDriverSeat(), Vector(-4,32,18), Vector(-10,60,120), true, "mg_muzzle" )
...
function simfphys.weapon:AimCannon( ply, vehicle, pod, Attachment )	
	...
	vehicle:SetPoseParameter("cannon_aim_pitch", math.Clamp(-TargetAng.p,-5 + pclamp,60) )
end
