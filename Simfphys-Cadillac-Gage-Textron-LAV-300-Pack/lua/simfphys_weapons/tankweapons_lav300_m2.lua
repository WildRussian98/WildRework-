...
local function minigunfire(ply,vehicle,shootOrigin,shootDirection)
	...
	vehicle:EmitSound("simulated_vehicles/weapons/autocanon/Close_Distance_2.ogg")
...
function simfphys.weapon:ValidClasses()
	return { "sim_fphys_tfre_lav300_3" }
end

function simfphys.weapon:Initialize( vehicle )
	net.Start( "simfphys_register_tank" )
		net.WriteEntity( vehicle )
		net.WriteString( "lav300m2" )
	net.Broadcast()
...
function simfphys.weapon:PrimaryAttack( vehicle, ply )
	...
	local AttachmentID = vehicle:LookupAttachment( "muzzle_left" )
