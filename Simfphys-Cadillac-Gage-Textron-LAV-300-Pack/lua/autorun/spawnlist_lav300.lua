...
list.Set( "simfphys_lights", "tfre_v300_1", light_table)

local V = {
	Name = "LAV-300 50mm",
	Model = "models/TFRE/vehicles/LAV300/LAV300_1.mdl",
...
list.Set( "simfphys_vehicles", "sim_fphys_tfre_lav300_1", V )
