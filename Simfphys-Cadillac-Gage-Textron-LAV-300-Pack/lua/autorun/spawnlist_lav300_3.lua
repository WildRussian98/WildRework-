...
list.Set( "simfphys_lights", "tfre_v300_3", light_table)

local V = {
	Name = "LAV-300 20mm",
	Model = "models/TFRE/vehicles/LAV300/LAV300_3.mdl",
...
list.Set( "simfphys_vehicles", "sim_fphys_tfre_lav300_3", V )
