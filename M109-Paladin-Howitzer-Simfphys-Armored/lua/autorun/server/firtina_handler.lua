...
sound.Add( {
	...
	level = 140,
	pitch = { 90, 110 },
	sound = "^simulated_vehicles/weapons/firtina_cannon.wav"
} )
sound.Add( {
	name = "tiger_fire_mg",
	channel = CHAN_STATIC,
...
sound.Add( {
	...
	level = 140,
	pitch = { 90, 110 },
	sound = "^simulated_vehicles/weapons/rocket.wav"
} )
...
function simfphys.FirePhysProjectile( data )
	...
	local projectile = ents.Create( "simfphys_tankprojectile_firtina" )
