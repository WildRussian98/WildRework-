	...
	if trace.Hit then
		...
		local bullet = {}
			...
			bullet.Callback = function(att, tr, dmginfo)
				...
				util.BlastDamage( attackingEnt, self.Attacker, tr.HitPos,self.BlastRadius,150)//self.BlastDamage
				util.ScreenShake( tr.HitPos, 175, 50, 12, self.BlastRadius+500 )
