...
local DeflectSounds = {
	"simulated_vehicles/weapons/physproj_rico.ogg",
	"simulated_vehicles/weapons/physproj_rico1.ogg",
	"simulated_vehicles/weapons/physproj_rico2.ogg",
	"simulated_vehicles/weapons/physproj_rico3.ogg",
}
...
function ENT:Think()	
	...
	if trace.Hit then
		...
		self.smVal = self.smVal and self.smVal + math.Clamp(0 - self.smVal,-Rate,Rate)  or 0
