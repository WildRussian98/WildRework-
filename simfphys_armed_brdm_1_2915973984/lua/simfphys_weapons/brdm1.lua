...
function simfphys.weapon:Initialize( vehicle )
	net.Start( "brdm1_register_tank")
		net.WriteEntity( vehicle )
		net.WriteString( "brdm1" )
	net.Broadcast()
	...
	simfphys.RegisterCamera( vehicle.pSeat[1], Vector(-13,-2.5,-0.1), Vector(0,0,50), true,"mashingun_cannon_pitch" )
