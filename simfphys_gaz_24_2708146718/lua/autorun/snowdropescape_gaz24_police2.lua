	...
	ems_sprites = {
		{
			...
			size = 45,
			Colors = {Color(255,4,0,255),Color(0,0,0,255),Color(0,0,0,250)},
			Speed = 0.1,
		},
		{
			pos = Vector(-1,0,38),
...
list.Set( "simfphys_lights", "SnowdropEscape_Gaz24_Police2", light_table)

local V = {
	Name = "ГАЗ-24 Полиция",
	Model = "models/SnowdropEscape_Gaz24_Police2.mdl",
	...
	Members = {
		...
		LightsTable = "SnowdropEscape_Gaz24_Police2",
		CustomWheels = true,
		CustomSuspensionTravel = 15,
		
		CustomWheelModel = "models/SnowdropEscape_Gaz24_Wheel2.mdl",
...
list.Set( "simfphys_vehicles", "SnowdropEscape_Gaz24_Police2", V )
