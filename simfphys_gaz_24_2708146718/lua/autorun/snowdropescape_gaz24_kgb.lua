...
list.Set( "simfphys_lights", "SnowdropEscape_Gaz24_KGB", light_table)

local V = {
	Name = "ГАЗ-24 КГБ",
	Model = "models/SnowdropEscape_Gaz24_KGB.mdl",
	...
	Members = {
		...
		LightsTable = "SnowdropEscape_Gaz24_KGB",
		CustomWheels = true,
		CustomSuspensionTravel = 15,
		
		CustomWheelModel = "models/SnowdropEscape_Gaz24_Wheel3.mdl",
...
list.Set( "simfphys_vehicles", "SnowdropEscape_Gaz24_KGB", V )
