	...
	ems_sprites = {
		{
			...
			size = 45,
			Colors = {Color(0,109,250,255),Color(0,0,0,255),Color(0,0,0,250)},
			Speed = 0.1,
		},
		{
			pos = Vector(-5,21,38),
...
list.Set( "simfphys_lights", "SnowdropEscape_Gaz24_Police", light_table)

local V = {
	Name = "ГАЗ-24 Милиция",
	Model = "models/SnowdropEscape_Gaz24_Police.mdl",
	...
	Members = {
		...
		LightsTable = "SnowdropEscape_Gaz24_Police",
		CustomWheels = true,
...
list.Set( "simfphys_vehicles", "SnowdropEscape_Gaz24_Police", V )
