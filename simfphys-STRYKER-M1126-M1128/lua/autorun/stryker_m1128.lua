...
list.Set( "simfphys_lights", "simphys", light_table) -- здесь тебе нужно изменить "test" на любое другое название, например "myfirstsimfcar"



local V = {
	Name = "Stryker M1128",
	Model = "models/stryker_m1128_mgs.mdl",
	...
	Members = {
		...
		GibModels = {
			"models/stryker_m1128_mgs_destroyed.mdl",
		},
...
list.Set( "simfphys_vehicles", "simphys_stryker_105", V )
