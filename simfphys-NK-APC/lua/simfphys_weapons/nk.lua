...
function simfphys.weapon:Initialize( vehicle )
	...
	simfphys.RegisterCrosshair( vehicle:GetDriverSeat(), { Attachment = "muzzle", Direction = Vector(0, 0, -1), Type = 2 } )
...
function simfphys.weapon:SecondaryAttack( vehicle, ply, shootOrigin, Attachment )
	...
	local AttachmentID = vehicle.swapMuzzle and vehicle:LookupAttachment( "muzzle_up" ) or vehicle:LookupAttachment( "muzzle_down" )
